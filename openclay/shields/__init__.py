# __init__.py
"""
OpenClay: Universal AI Security Framework
...
Legacy API (Deprecated):
    from openclay.shields import InputShield_L5  # Deprecated
"""
...
from .exceptions import StreamBlockedError, OpenClayError
...
# Testing
from .testing import OpenClayEvasionTester

# Telemetry
from .telemetry import OpenClayTelemetry, trace_shield_call, telemetry
