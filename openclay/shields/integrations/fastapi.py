"""
FastAPI Middleware for OpenClay.
...
Usage:
    ...
    from openclay.integrations.fastapi import OpenClayMiddleware
...
class OpenClayMiddleware(BaseHTTPMiddleware):
    """
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        # Add shield headers
        response.headers["X-OpenClay-Latency-Ms"] = str(round(latency_ms, 2))
        response.headers["X-OpenClay-Threat-Level"] = str(
