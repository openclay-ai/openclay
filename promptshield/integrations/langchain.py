"""
LangChain / LangGraph Integration for PromptShield.
...
Usage:
    ...
    handler = PromptShieldCallbackHandler(shield=shield)
...
_threat_var: contextvars.ContextVar[float] = contextvars.ContextVar(
    "promptshield_threat", default=0.0
)
...
class PromptShieldCallbackHandler(_BaseClass):
    """
    LangChain callback handler that enforces PromptShield at every stage.
    ...
    def on_llm_end(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.warning("PromptShield on_llm_end extraction failed: %s", e)
